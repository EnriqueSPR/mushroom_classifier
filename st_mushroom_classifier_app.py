...
**Description**: This app was built to classify pictures of mushrooms with Convolutional Neural Networks (CNNs). 
...
if mush:
    list_classes = pd.read_csv("files/labels_925.csv")
...
if uploaded_file:
    ...
    if selected_model == "Xception":
        ...
        list_classes = pd.read_csv("files/labels_933.csv")
        list_classes = list(list_classes["Names"])
